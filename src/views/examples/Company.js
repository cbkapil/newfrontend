...
const Company = () => {
  ...
  const handleRowUpdate = async (newData, oldData, resolve) => {
    ...
    let result = await fetch(`/update/${newData._id}`, {
      method: "put",
      body: JSON.stringify({
        newData,
      }),
  ...
  const handleRowDelete = async (oldData, resolve) => {
    ...
    let result = await fetch(`/delete/${oldData._id}`, {
      method: "delete",
                          ...
                          <CardBody className="mycard">
                            <div className="card-navbar">
                              <div className="card-nav">
                                ...
                                <h2 className="m-0 p-0 text-white">Company Details</h2>
