...
console.log("====================>>>>>>> ",chequeFirmid)
        ...
        let result = await fetch("/getbank2", {
          method: "post",
  ...
  // ****************Remove Duplicates ************************
   ...
   const getChequeBranch = async () => {
    ...
    if (chequeFirmid && chequeBankid) {
        ...
        let result = await fetch("/getbranches", {
          method: "post",
  ...
  const getChequeAccount = async () => {
    ...
    if (chequeFirmid && chequeBankid && chequeBranchid) {
      ...
      let result = await fetch("/getaccount", {
        method: "post",
  ...
  const getdocno= async () => {
     ...
     if (chequeBankid){
      ...
      console.log("me hu console.log");
      let result = await fetch("/getdocno", {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer " + token,
...
console.log(docno)
  ...
  const searchbydate = async (e) => {
    ...
    if ((chequeFirmid || chequefirmname)&& todate) {
      let result = await fetch("/searchbydatecheque", {
        method: "post",
...
console.log("chequedata",dataa)
  if (accountno && chequeBankid && chequeBranchid ) {
    ...
    let result = await fetch("/createchequeslip", {
      method: "post",
...
//       let result = await fetch("/senddocketdata", {
//         method: "post",
...
//   };
  ...
  const sendprintdata = async (dataa) => {
    ...
    if((chequeBankid === '') ||  chequeBranchid === '' ||  accountno === ''){
      ...
      await axios({
        ...
        url : '/chequeprint',
        method : 'POST',
        data:JSON.stringify({docno,dataa,chequeBankid,chequeBranchid,accountno,print}),
        responseType : 'blob',
  ...
  const handleRowUpdate = async (newData, oldData, resolve) => {
    ...
    let result = await fetch(`/updatecheque/${newData._id}`, {
      method: "put",
      body: JSON.stringify({
        newData,
      }),
  ...
  const getData = async () => {
    let result = await fetch("/getbank", {
      method: "GET",
  ...
  const onGridReady = async () => {
    let result = await fetch("/getchequeslips", {
      method: "GET",
  ...
  {title:"Date",field:"chequedate",editComponent: (props,newData,rowData) => {
    console.log(props);
            ...
            <Form className="p-0">
                <div className="m-0 d-flex ">
                    ...
                    <div className="input">
                        ...
                        <Button style={{width : "100px", height : "45px",  margin : "35px 0 0 15px", background : "linear-gradient(45deg, #38a381, #3db150)"  }} onClick={(e)=>{searchbydate(e)}}>
                            Search
                        </Button>
                </div>
            </Form>
